...
#25/11/2020
#Este programa, lê um arquivo csv, mostra em um treeview, plota e salva.
...
def formSalvar():
	...
	fl= fd.asksaveasfilename(filetypes=ftypes)

	if fl:
		arquivo = open(fl, "w")
		arquivo.write("0;"+"1;"+"1;"+"1;"+"\n")
		arquivo.close
...
filemenu.add_command(label="Salvar", command=formSalvar)
...
formPrincipal.title("Gera plota 4")
