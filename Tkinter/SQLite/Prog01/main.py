...
def inserir():
	if vnome.get() ==  "" or vfone.get() == "":
		messagebox.showinfo(title = "ERRO", message = "Digiet todos os dados")
		return
	try:
...
app = Tk()
app.title("Banco de dados com SQLite")
...
btn_inserir = Button(quadroInserir, text = "Inserir", command = insert)
...
btn_pesquisar = Button(quadroPesquisar, text = "Pesquisar", commmand = pesquisar)
btn_pesquisar.pack(side = "left", padx = 10)
btn_todos = Button(quadroPesquisar, text = "Mostrar todos", commmand = popular)
